...
TEST(test_deserializer, many_objects_in_buffer) {
  ...
  std::vector<uint8_t> buffer = {
      0b10000000, 0,          0,          4,  0,          1,  2,
      3,          0b10000000, 0,          0,  6,          4,  5,
      6,          7,          8,          9,  0b10000000, 0,  0,
      3,          10,         11,         12, 0b10000000, 0,  0,
      8,          13,         14,         15, 16,         17, 18,
      19,         20,         0b10000000, 0,  0,          1,  21,
...
TEST(test_deserializer, buffer_overlap_objects) {
  ...
  std::vector<std::vector<uint8_t>> buffers = {
      ...
      {0b00000000, 0, 0, 2, 2, 3, 0b10000000, 0, 0, 17, 4, 5, 6, 7, 8, 9},
      {0b00000000, 0, 0, 11, 10, 11, 12},
      {0b00000000, 0, 0, 8, 13, 14, 15, 16, 17, 18, 19, 20, 0b10000000, 0, 0, 1,
       21},
      {0b10000000, 0, 0, 3, 22, 23, 24}};
...
TEST(test_deserializer, lost_buffer) {
  ...
  std::vector<std::vector<uint8_t>> buffers = {
      ...
      {0b00000000, 0, 0, 1, 21, 0b10000000, 0, 0, 3, 22, 23, 24},
...
TEST(test_deserializer, lost_buffers_and_zero_padding) {
  ...
  std::vector<bool> processed_expectations = {false, true, false, false, true};
